...
void main() {
  group('Joker HTTP Stubbing', () {
    ...
    group('JSON Stubbing', () {
      test('should stub JSON GET request', () async {
        Joker.start();
      ...
      test('should stub JSON POST request with custom status code', () async {
        Joker.start();
